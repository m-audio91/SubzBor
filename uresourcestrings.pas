...
resourcestring
  ...
  rsIsMillisecondAFrameNoDesc = 'برخی نرم افزارهای ویرایش خطی ویدئو، عدد دقیق هزارم ثانیه را' + LineEnding + 'نشان نمی دهند و بجای آن شماره تصویر (شماره فریم) را نشان می دهند مانند:'
    +LineEnding + 'hh:mm:ss:ff' + LineEnding + 'که در اینصورت برای گرفتن برش های دقیق باید به سابزبُر اعلام کنید قسمت' + LineEnding + ':ff' + LineEnding + 'را به' + LineEnding + ':ms' + LineEnding + '(هزارم ثانیه) تبدیل کند و نرخ تصویر دقیق پروژه' + LineEnding + 'خود را در پایین وارد نمایید.';
  rsFramerate = 'نرخ فریم مرجع:';
  rsFramerateHint = 'کدزمان ها و زمانبندی ها دارای نرخ فریم نیستند' + LineEnding + 'اما برای انجام تبدیل شماره فریم به کدزمان و همچنین تبدیل' + LineEnding + 'HH:MM:SS:FF' + LineEnding + 'به' + LineEnding + 'HH:MM:SS:MS' + LineEnding + 'وارد کردن نرخ فریم دقیق مرجع ضروری است';
  rsIsNormalTimeCode = 'کدزمان';
  rsIsFramePos = 'شماره فریم';
  rsIsFramePosHint = 'شماره فریم یک عدد صحیح است که موقعیت فریم را از ابتدای فایل مشخص می کند' + LineEnding + 'مثلا فریم هزار و دویست و پنجاه و ششم' + LineEnding + 'قبل از انتخاب این گزینه توجه کنید که حتما اعداد ورودیتان شماره فریم هستند';
