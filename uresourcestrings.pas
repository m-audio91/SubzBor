...
resourcestring
  ...
  rsIsMillisecondAFrameNoDesc = 'برخی نرم افزارهای ویرایش خطی ویدئو، عدد دقیق هزارم ثانیه را' + LineEnding + 'نشان نمی دهند و بجای آن شماره تصویر (شماره فریم) را نشان می دهند مانند:'
    +LineEnding + 'hh:mm:ss:ff' + LineEnding + 'که اگر می خواهید سابزبُر برای شما عدد مذکور را به هزارم ثانیه' + LineEnding + 'تبدیل کند می توانید این گزینه را فعال و نرخ تصویر دقیق پروژه' + LineEnding + 'خود را که ویرایشگر ویدئوتان نشان می دهد در پایین وارد نمایید.'
    +LineEnding + 'توجه: تبدیل در زمان وارد شدن زمان بندی به لیست اصلی انجام می شود.';
